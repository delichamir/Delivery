...
export class dump1580912108354 implements MigrationInterface {
	public async up(queryRunner: QueryRunner): Promise<any> {
      ...
      PRIMARY KEY ("product_id") 
		...
		await queryRunner.query(`CREATE TABLE IF NOT EXISTS "restaurant_product" (
      ...
      FOREIGN KEY ("product_id") REFERENCES product("product_id") 
		...
		await queryRunner.query(`CREATE TABLE IF NOT EXISTS "cart_detail" (
      ...
      FOREIGN KEY ("restaurant_product_id") REFERENCES restaurant_product("restaurant_product_id") 
		...
		await queryRunner.query(`CREATE TABLE IF NOT EXISTS "order_detail" (
